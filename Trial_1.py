...
#     _, dma_search_col = st.columns([4, 2])
#     with dma_search_col:
...
#                 "💾 SAVE ALL CHANGES", type="primary", key="dma_save_all_changes", use_container_width=True
#             )
...
#     _, iro_search_col = st.columns([4, 2])
#     with iro_search_col:
...
#                 "💾 SAVE ALL CHANGES", type="primary", key="iro_save_all_changes", use_container_width=True
#             )
...
#     kpi_framework_col, kpi_search_col = st.columns(2)
